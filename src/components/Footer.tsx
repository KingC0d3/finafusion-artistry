      ...
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-2xl font-semibold text-text-light tracking-wider mb-2">
              Finafusion
            </h3>
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              href="https://wa.me/2348061791997"
              target="_blank"
              rel="noopener noreferrer"
              className="text-text-light hover:text-gold transition-colors p-2"
              aria-label="WhatsApp"
            ...
            <a
              href="https://tiktok.com/@finafusion"
              target="_blank"
              rel="noopener noreferrer"
              className="text-text-light hover:text-gold transition-colors p-2"
              aria-label="TikTok"
            ...
            <a
              href="mailto:finafusion@gmail.com"
              className="text-text-light hover:text-gold transition-colors p-2"
              aria-label="Email"
            >
              <Mail size={22} />
